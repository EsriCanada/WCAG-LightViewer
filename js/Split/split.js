define([
    ...
    var Widget = declare("esri.dijit.SplitPanel", [
        _WidgetBase, 
        //_TemplatedMixin, 
        Evented], {
        ...
        constructor: function (options, srcRefNode) {
            ...
            link.href = "js/Split/Templates/split.css";
            link.type = "text/css";
            link.rel = "stylesheet";
        ...
        elementStyle : function (dimension, size, gutterSize) {
            ...
            if (typeof size !== 'string' && !(size instanceof String)) {
                if (!isIE8) {
                    style[dimension] = this.calc + '(' + size + '% - ' + this.defaults.gutterSize + 'px)';
                } else {
        ...
        gutterStyle : function (dimension, gutterSize) {
            ...
            style[dimension] = this.defaults.gutterSize + 'px';
  ...
  Split : function (ids, options) {
    ...
    var startDragging = function (e) {
            ...
            var self = this, a = self.a, b = self.b
            ;
      ...
      calculateSizes = function () {
            ...
            var parentSize = this.parent[clientDimension] - parseFloat(computedStyle[paddingA]) - parseFloat(computedStyle[paddingB]);
    ...
    for (i = 0; i < ids.length; i++) {
        ...
        var pair;
        var parentFlexDirection = window.getComputedStyle(parent).flexDirection;
        var temp;
    ...
    return {
        ...
        getSizes: function () {
            ...
            for (var i = 0; i < pairs.length; i++) {
                ...
                var parentSize = pair.parent[clientDimension] - parseFloat(computedStyle[paddingA]) - parseFloat(computedStyle[paddingB]);
...
// Call our wrapper function with the current global. In this case, `window`.
    ...
    if (has("extend-esri")) {
        lang.setObject("dijit.SplitPanel", Widget, esriNS);
    }
    return Widget;
});